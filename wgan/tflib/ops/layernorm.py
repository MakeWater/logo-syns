...
def Layernorm(name, norm_axes, inputs): # norm_axes = [1,2,3]
    ...
    n_neurons = inputs.get_shape().as_list()[norm_axes[0]] # get input shape as list and get axis 1 dimension.
    ...
    offset = tf.reshape(offset, [-1] + [1 for i in xrange(len(norm_axes)-1)]) # [-1]+[1,1] = [-1,1,1]
